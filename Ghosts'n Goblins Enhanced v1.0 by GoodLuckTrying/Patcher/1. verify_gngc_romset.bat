...
set "PS1_SCRIPT=Get-CRC32-gngc.ps1"
...
echo Checking files...
echo.
set "filename=gng.n10" & set "expected_crc=60343188" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul ^| findstr /r /c:"^[0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]$"') do set "actual_crc=%%h" & if "!actual_crc!"=="!expected_crc!" (echo [PASS] !filename! - CRC32: !actual_crc! & set /a passed_count+=1) else (echo [FAIL] !filename! & echo        Expected: !expected_crc! & echo        Actual:   !actual_crc! & set /a failed_count+=1))

set "filename=gng.n9" & set "expected_crc=b6b91cfb" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul ^| findstr /r /c:"^[0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]$"') do set "actual_crc=%%h" & if "!actual_crc!"=="!expected_crc!" (echo [PASS] !filename! - CRC32: !actual_crc! & set /a passed_count+=1) else (echo [FAIL] !filename! & echo        Expected: !expected_crc! & echo        Actual:   !actual_crc! & set /a failed_count+=1))

set "filename=gng.n8" & set "expected_crc=a5cfa928" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul ^| findstr /r /c:"^[0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]$"') do set "actual_crc=%%h" & if "!actual_crc!"=="!expected_crc!" (echo [PASS] !filename! - CRC32: !actual_crc! & set /a passed_count+=1) else (echo [FAIL] !filename! & echo        Expected: !expected_crc! & echo        Actual:   !actual_crc! & set /a failed_count+=1))

set "filename=gng.n13" & set "expected_crc=fd9a8dda" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul ^| findstr /r /c:"^[0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]$"') do set "actual_crc=%%h" & if "!actual_crc!"=="!expected_crc!" (echo [PASS] !filename! - CRC32: !actual_crc! & set /a passed_count+=1) else (echo [FAIL] !filename! & echo        Expected: !expected_crc! & echo        Actual:   !actual_crc! & set /a failed_count+=1))

set "filename=gng.n12" & set "expected_crc=13cf6238" & set /a total_files+=1 & if not exist "%ROM_DIR%\!filename!" (echo [MISSING] !filename! & set /a missing_count+=1) else (for /f "delims=" %%h in ('powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0%PS1_SCRIPT%" "%ROM_DIR%\!filename!" 2^>nul ^| findstr /r /c:"^[0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]$"') do set "actual_crc=%%h" & if "!actual_crc!"=="!expected_crc!" (echo [PASS] !filename! - CRC32: !actual_crc! & set /a passed_count+=1) else (echo [FAIL] !filename! & echo        Expected: !expected_crc! & echo        Actual:   !actual_crc! & set /a failed_count+=1))
